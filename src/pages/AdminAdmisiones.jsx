...
export default function AdminAdmisiones() {
  ...
  async function loadAdmissions() {
    try {
      ...
      setError("No se pudieron cargar los pasos de admisión.");
    } finally {
      setCargando(false);
    }
  }
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      console.error(e);
      if (e.message === "NO_ADMIN_AUTH") return;
      setError(e.message || "Error al guardar el paso de admisión");
    }
  }
  ...
  async function handleEliminar(id) {
    const seguro = window.confirm(
      "¿Seguro que quieres eliminar este paso de admisión?"
    );
    if (!seguro) return;
    ...
    try {
      ...
      console.error(e);
      if (e.message === "NO_ADMIN_AUTH") return;
      setError(e.message || "Error al eliminar el paso de admisión");
    }
  }
    ...
    <div className="admin-page">
      ...
      <div className="admin-grid">
                  ...
                  <tr key={step.id}>
                    ...
                    <td className="col-actions">
                      ...
                      <button
                        ...
                        onClick={() => handleEliminar(step.id)}
                      >
                        Eliminar
                      </button>
                    </td>
        ...
        <section className="admin-form-section">
          <h2>{editandoId ? "Editar paso" : "Nuevo paso de admisión"}</h2>
          <form onSubmit={handleSubmit} className="admin-form">
            ...
            >
              <button type="submit" className="btn">
                {editandoId ? "Guardar cambios" : "Crear paso"}
              </button>
              {editandoId && (
                <button
                  type="button"
